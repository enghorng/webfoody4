<?php
    ...
    $foodSql1 = $con->query("SELECT * FROM `vuserfood` WHERE Category = 'Food' ORDER BY FoodDate DESC");    
                ...
                <div id="mySidenav" class="sidenav">
                    ...
                    <div class="container" style="margin-top: 70px; margin-left: 30px;">
                      ...
                      <form action="" id="filterFood">
                          ...
                          <div class="checkbox">
                              <label><input type="checkbox" value="" id="chNoWater">&nbsp;&nbsp;សម្លគោក</label>
                          </div>
                          <div class="checkbox">
                              <label><input type="checkbox" value="" id="chWater">&nbsp;&nbsp;សម្លទឹក</label>
                          </div>
                          <div class="button">
