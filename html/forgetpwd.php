...
<body>    
    <div class="container">
        <div class="row formRegister"​​​ style="margin-top:70px;">
            <div class="col-md-6 offset-md-3 shadow-lg p-3 mb-5 bg-white rounded">
                <form action="../php/register.php" method="POST">
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <h2 class="title text-center"> ភ្លេចលេខសម្ងាត់ </h2>
                        </div>
                    </div>
                    ...
                    <div class="form-row info">
                        ...
                        <div class="form-group col-md-9">
                            <input type="email" class="form-control" id="txtEmail" name="txtEmail" placeholder="អ៊ីមែល" required autofocus>
                            <p id="msgErrEmail"><p>
                        </div>
                    </div>
                    <div class="form-row info">
            ...
            $("#txtEmail").keyup(function () {                
                ...
                for(var i=0; i<emailList.length; i++){
                    if($("#txtEmail").val()==emailList[i]){
                        ...
                        mail = 0;
                        $('#msgErrEmail').html('<br>អ៊ីមែលនេះទាន់មានគណនីទេ').css('color', 'red');
                    }
                }
