        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <a class="nav-link text-white" href="#">អាហារខ្មែរ<span class="sr-only">(current)</span></a>
                ...
                <li class="nav-item ab">
                    <a class="nav-link text-white display-none" href="html/login.php" id="navUser">អ្នកប្រើប្រាស់</a>
                </li>
                <?php
                    if($role==0){
                        echo '<script type="text/javascript">
        ...
        <div class="container" style="margin-bottom: 20px;">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-6 gallery display-none" id="galleryAdmin">
                    <a target="_blank" href="./html/admin.php">
                        <img src="./images/Icon/adminicon.png">
                    </a>
                    <div class="desc">
                        <a href="./html/admin.php">រដ្ឋបាល</a>
                    </div>
                </div>
                <?php  
                    if($role==0){
